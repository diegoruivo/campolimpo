            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li class="separator icon-angle-right icon-notext"></li>
                        <li><a href="{{ route('admin.users.create') }}" class="text-orange">Criar Novo Cliente</a></li>
                    </ul>
                </nav>
            </div>
        </header>
                            ...
                            <div class="app_collapse mt-2">
                                ...
                                <div class="app_collapse_content d-none">
                                    ...
                                    <div class="label_gc">
                                        ...
                                        <label class="label">
                                            <input type="checkbox"
                                                   name="provider" {{ (old('provider') == 'on' || old('provider') == true ? 'checked' : ($user->client == true ? 'checked' : '')) }}><span>Fornecedor</span>
                                        </label>
                                    </div>
