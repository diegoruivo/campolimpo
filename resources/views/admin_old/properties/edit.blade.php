...
@section('content')
    ...
    <header class="dash_content_app_header">
        <h2><i class="fa fa-house-user"></i> Cadastrar Novo Imóvel</h2>
            ...
            <form action="{{ route('admin.properties.update', ['property' => $property->id]) }}" method="post" class="app_form" enctype="multipart/form-data">
                ...
                <div class="nav_tabs_content">
                    ...
                    <div id="documents" class="d-none">
                        ...
                        <p class="text-right">
                            <a href="{{ route('admin.documents.create', ['property' => $property->id, 'user' => $user->id]) }}"
                               class="btn btn-blue icon-building-o">Cadastrar Novo Documento</a>
                        </p>

                        <label class="label">
                            <span class="legend">Documentos</span>
                        </label>
