...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form role="form" action="{{ route('admin.terms.store') }}" method="post" enctype="multipart/form-data">
            ...
            <!-- Default box -->
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Cadastro de Termo Contratual</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <button type="submit" class="btn btn-lg bg-gradient-primary" style="float:right;"><i
                                        class="fa fa-long-arrow-alt-right"></i> Cadastrar Termo Contratual
                            </button>
                        </div>
                        <!-- /.card-footer-->
                    </div>
