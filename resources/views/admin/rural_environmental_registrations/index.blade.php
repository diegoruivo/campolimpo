                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <a href="{{ route('admin.rural_environmental_registrations.create') }}">
                                <button type="button" class="btn bg-gradient-primary ml-3"><i class="fa fa-plus"></i> Cadastrar CAR</button>
                            </a>
                        </ol>
                    </div>
                </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @if(!empty($rural_environmental_registrations))
                            @foreach($rural_environmental_registrations as $rural_environmental_registry)
                                <tr>
                                    <td>{{ $rural_environmental_registry->user()->first()->name }}</td>
