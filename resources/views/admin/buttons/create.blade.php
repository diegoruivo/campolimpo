...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Cadastrar Botão</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <form role="form" action="{{ route('admin.buttons.store') }}" method="post">
            ...
            <!-- Default box -->
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-lg bg-gradient-primary" style="float:right;"><i class="fa fa-long-arrow-alt-right"></i> Cadastrar Botão</button>
                    </div>
                    <!-- /.card-footer-->
                </div>
                <!-- /.card -->
