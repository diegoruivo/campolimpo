                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="title" placeholder="Título" value="{{ old('title') ?? $system->title }}" required/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="string" name="site" class="form-control" placeholder="Site" value="{{ old('site') ?? $system->site }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="tel" name="telephone" class="form-control" class="mask-phone" placeholder="Número do Telefonce com DDD" value="{{ old('telephone') ?? $system->telephone }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="tel" name="cell" class="form-control" class="mask-cell" placeholder="Número do Telefonce com DDD" value="{{ old('cell') ?? $system->cell }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control" placeholder="Melhor e-mail" value="{{ old('email') ?? $system->email }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="facebook" class="form-control" placeholder="Endereço do Facebook" value="{{ old('facebook') ?? $system->facebook }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="instagram" class="form-control" placeholder="Endereço do Instagram" value="{{ old('instagram') ?? $system->instagram }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="twitter" class="form-control" placeholder="Endereço do Twitter" value="{{ old('twitter') ?? $system->twitter }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="youtube" class="form-control" placeholder="Endereço do Youtube" value="{{ old('youtube') ?? $system->youtube}}"/>
                                    </div>
                                </div>
                            </div>
