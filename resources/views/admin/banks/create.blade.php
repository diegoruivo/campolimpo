...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form role="form" action="{{ route('admin.banks.store') }}" method="post" enctype="multipart/form-data">
            ...
            <!-- Default box -->
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-lg bg-gradient-primary" style="float:right;"><i class="fa fa-long-arrow-alt-right"></i> Cadastrar Banco</button>
                    </div>
                    <!-- /.card-footer-->
                </div>
                <!-- /.card -->
