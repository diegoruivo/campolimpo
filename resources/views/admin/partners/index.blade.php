                    ...
                    <div class="col-sm-8">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <a href="{{ route('admin.partners.create') }}">
                                <button type="button" class="btn bg-gradient-primary ml-3"><i class="fa fa-plus"></i> Cadastrar Parceiro Site</button>
                            </a>
                        </ol>
                    </div>
                </div>
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Lista de Parceiros Site</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
