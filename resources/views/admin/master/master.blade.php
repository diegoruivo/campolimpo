...
<div class="dash">
    <aside class="dash_sidebar">
        ...
        <ul class="dash_sidebar_nav">
            ...
            <li class="dash_sidebar_nav_item {{ isActive('admin.users') }} {{ isActive('admin.companies') }} {{ isActive('admin.properties') }} {{ isActive('admin.documents') }}"><a class="icon-users" href="{{ route('admin.users.index') }}">Clientes</a>
                <ul class="dash_sidebar_nav_submenu">
                    ...
                    <li class="{{ isActive('admin.documents.index') }}"><a href="{{ route('admin.documents.index') }}">Documentos</a></li>
            ...
            <li class="dash_sidebar_nav_item {{ isActive('admin.services') }}"><a class="icon-tags" href="{{ route('admin.services.index') }}">Serviços</a>
                <ul class="dash_sidebar_nav_submenu">
        ...
        <div class="dash_userbar">
            <div class="dash_userbar_box">
                <div class="dash_userbar_box_content">
                    ...
                    <h1 class="transition">
                        <i class="icon-imob text-orange"></i><a href="{{ route('admin.home') }}">Campo<b>Limpo</b></a>
                    </h1>
