...
<div class="dash">
    <aside class="dash_sidebar">
        ...
        <ul class="dash_sidebar_nav">
            ...
            <li class="dash_sidebar_nav_item {{ isActive('admin.calls') }}"><a class="icon-comments-o" href="{{ route('admin.calls.index') }}">Atendimento</a>
            ...
            <li class="dash_sidebar_nav_item {{ isActive('admin.users') }} {{ isActive('admin.companies') }} {{ isActive('admin.properties') }} {{ isActive('admin.documents') }}">
                ...
                <ul class="dash_sidebar_nav_submenu">
                    ...
                    <li class="{{ isActive('admin.properties.index') }}"><a
                                href="{{ route('admin.properties.index') }}">Propriedades</a></li>
                    <li class="{{ isActive('admin.users.create') }}"><a href="{{ route('admin.users.create') }}">Criar
                            Novo</a></li>
                </ul>
            </li>
            <li class="dash_sidebar_nav_item {{ isActive('admin.services') }}"><a class="icon-tags"
